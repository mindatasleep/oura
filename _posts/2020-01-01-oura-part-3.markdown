---
layout: post
title:  "Automate a Deployment Pipeline for a Rails + Docker app"
...
# CI / CD Workflow: Docker + Rails + PostgreSQL + GitLab CI/CD + DigitalOcean (January 2020)
...
http://64.227.88.162:3000/picknick
