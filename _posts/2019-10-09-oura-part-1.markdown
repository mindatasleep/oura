...
```
Reaching this step asserts the app successfully authenticated which will allow the app to request the user's daily summaries. [See the documentation of the API schema for calls and responses.](https://cloud.ouraring.com/docs/daily-summaries)
